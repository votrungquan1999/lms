...
Admins organize educational content into courses. Each course contains lessons and tests. Students are enrolled in courses to access their content.

## User Roles

- **Admin**: Full CRUD on courses, lessons, and enrollments
- **Student**: View enrolled courses and their content
...
- [ ] Admin can add lessons to a course
- [ ] Each lesson has a title, description, and optional file attachments
- [ ] Admin can reorder lessons within a course
- [ ] Admin can update or delete lessons
